...
void HIT_1::populateSkipListLevel_0(unsigned int blockNumber, unsigned int itemIdx)
{
     /* Level 0*/
...
void HIT_1::populateSkipListLevels(unsigned int blockNumber)
{
     /* Level >=1 */
...
HIT_1::HIT_1(unsigned int windowSize, float gamma, unsigned int m, float epsilon)
...
void HIT_1::update(unsigned int item, int wieght)
{
	++frameItems;
#ifdef DEBUGGING
...
double HIT_1::query(unsigned int item)
{
    int minOverFlows;
...
unsigned int HIT_1::partialIntervalQuery(unsigned int itemIdx, unsigned int b2, unsigned int b1)
{
	unsigned int b = b1;
...
double HIT_1::intervalQuery(unsigned int item, int b2, int b1)
{
...
#ifdef DEBUGGING
double HIT_1::testIntervalQuery(unsigned int b2, unsigned int b1)
{
